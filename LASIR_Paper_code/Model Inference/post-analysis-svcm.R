...
model_list_res <- readRDS("/Volumes/easystore/Dropbox/U-Mich/Research/ABCD/EM_RDA/section2-EM-run/model_list_svcm_res.rds")
BIC_list_res <- readRDS("/Volumes/easystore/Dropbox/U-Mich/Research/ABCD/EM_RDA/section2-EM-run/BIC_list_svcm_res.rds")
main_effect_coef <- readRDS("/Volumes/easystore/Dropbox/U-Mich/Research/ABCD/EM_RDA/section3-post-process/est_main_effect_svcm.rds")
pval_est_main_effect <- readRDS("/Volumes/easystore/Dropbox/U-Mich/Research/ABCD/EM_RDA/section3-post-process/pval_est_main_effect_svcm.rds")
sd_est_main_effect <- readRDS("/Volumes/easystore/Dropbox/U-Mich/Research/ABCD/EM_RDA/section3-post-process/est_sd_main_effect_svcm.rds")
...
pval_dir = "/Volumes/easystore/Dropbox/U-Mich/Research/ABCD/EM_RDA/section3-post-process/alpha_pval_svcm"
coef_dir = "/Volumes/easystore/Dropbox/U-Mich/Research/ABCD/EM_RDA/section3-post-process/alpha_coef_svcm"
...
for(j in 1:(J+1)){
  ...
  for(k in 1:nK){
    ...
    filename1_sig_coef = file.path(coef_dir, sprintf("alpha_%s_tval_k%d", filename, k))
    oro.nifti::writeNIfTI(alpha_img_list_sig[[j]][[k]], filename=filename1_sig_coef)
  }
}
...
for(j in 1:(J+1)){
  ...
  for(k in 1:nK){
    ...
    alpha_sig_regions[[names_X[j]]][[k]]$all_roi = sum_table[,c("ROI", "X","Y","Z", "roi_sign", "Suggested System","vox_count")]
...
save(list = "alpha_sig_regions", file = "/Volumes/easystore/Dropbox/U-Mich/Research/ABCD/EM_RDA/section3-post-process/alpha_sig_regions_svcm_rho005_p14.RData")
