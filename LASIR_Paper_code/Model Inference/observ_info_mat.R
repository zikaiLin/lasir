...
for(k in 1:nK){
  main_effect_coef[,,k] = mod$main_basis_coef[,,k] %*% t(transform_res_p14_rho05$EigenFuns_fit.svd$u)
}
...
saveRDS(pval_est_main_effect, file = "./EM_RDA/section3-post-process/pval_est_main_effect.rds")
saveRDS(sd_est_main_effect, "./EM_RDA/section3-post-process/est_sd_main_effect.rds")
saveRDS(main_effect_coef, "./EM_RDA/section3-post-process/est_main_effect.rds")
