rm(list = ls())
load("/Volumes/easystore/Dropbox/U-Mich/Research/ABCD/EM_RDA/section2-EM-run/result_p12_rho05_varDF_1grp.RData")
...
pval_dir = "/Volumes/easystore/Dropbox/U-Mich/Research/ABCD/EM_RDA/section3-post-process/alpha_pval_1grp"
coef_dir = "/Volumes/easystore/Dropbox/U-Mich/Research/ABCD/EM_RDA/section3-post-process/alpha_coef_1grp"
...
for(j in 1:J){
  ...
  for(k in 1:nK){
    ...
    slot(a1_img,".Data")[input_dat$vox_eff] = m1$main_coef[j,, k] 
...
save(list = "alpha_sig_regions", file = "/Volumes/easystore/Dropbox/U-Mich/Research/ABCD/EM_RDA/section3-post-process/alpha_sig_regions_rho005_p12_1grp.RData")
