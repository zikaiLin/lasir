...
#   smoothness = 0.05,
#   poly_degree = 14)
# saveRDS(Y.eigen.trans, "./EM_RDA/section5-sensitivity/Y_eigen_trans_p14_r05.rds")
Y.eigen.trans = readRDS("./EM_RDA/section5-sensitivity/Y_eigen_trans_p14_r05.rds")

source("./mvEMfix_r_no_intercept.R")
model_list = list()
BIC_list = matrix(Inf, 8, 20)
for(k in 1:8){
  cat("k = ", k, "\n")
  model_list[[k]] = list()
  for(iter in 1:20){
...
saveRDS(model_list, "./EM_RDA/section2-EM-run/model_list_res_no_intercept.rds")
saveRDS(BIC_list, "./EM_RDA/section2-EM-run/BIC_list_res_no_intercept.rds")
