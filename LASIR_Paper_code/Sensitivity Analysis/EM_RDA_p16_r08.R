...
if(file.exists(sprintf("/Volumes/easystore/Dropbox/U-Mich/Research/ABCD/EM_RDA/section5-sensitivity/Y_eigen_trans_p%d_r0%d.rds", poly_degree, rho))){
  ...
  saveRDS(Y.eigen.trans, "/Volumes/easystore/Dropbox/U-Mich/Research/ABCD/EM_RDA/section5-sensitivity/Y_eigen_trans_p16_r08.rds")
...
model_list_p16_r08 = list()
BIC_list_p16_r08 = matrix(Inf, 6, 5)
for(k in 1:6){
  cat("k = ", k, "\n")
  model_list_p16_r08[[k]] = list()
  for(iter in 1:5){
    cat("* ")
    ...
    BIC_list_p16_r08[k,iter] = res_EM$BIC
    model_list_p16_r08[[k]][[iter]] = res_EM
...
list_of_vars_tosave = c("model_list_p16_r08", "BIC_list_p16_r08")
print(which(BIC_list_p16_r08 == min(BIC_list_p16_r08), arr.ind = T))

save(list = list_of_vars_tosave,
     file = "/Volumes/easystore/Dropbox/U-Mich/Research/ABCD/EM_RDA/section5-sensitivity/result_p16_rho08.RData")
