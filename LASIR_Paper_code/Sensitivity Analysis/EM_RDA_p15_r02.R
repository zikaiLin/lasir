...
if(file.exists(sprintf("/Volumes/easystore/Dropbox/U-Mich/Research/ABCD/EM_RDA/section5-sensitivity/Y_eigen_trans_p%d_r0%d.rds", poly_degree, rho))){
  ...
  saveRDS(Y.eigen.trans, "/Volumes/easystore/Dropbox/U-Mich/Research/ABCD/EM_RDA/section5-sensitivity/Y_eigen_trans_p15_r02.rds")
...
model_list_p15_r02 = list()
BIC_list_p15_r02 = matrix(Inf, 6, 5)
for(k in 1:6){
  cat("k = ", k, "\n")
  model_list_p15_r02[[k]] = list()
  for(iter in 1:5){
    cat("* ")
    ...
    BIC_list_p15_r02[k,iter] = res_EM$BIC
    model_list_p15_r02[[k]][[iter]] = res_EM
    
  }
  cat("\n")
}
print(which(BIC_list_p15_r02 == min(BIC_list_p15_r02), arr.ind = T))

list_of_vars_tosave = c("model_list_p15_r02", "BIC_list_p15_r02")

save(list = list_of_vars_tosave,
     file = "/Volumes/easystore/Dropbox/U-Mich/Research/ABCD/EM_RDA/section5-sensitivity/result_p15_rho02.RData")
